...
# 📝 Publications
## Journal Papers
1. **A. Tang**, S.H. Song, C.-Y. Tsui, Rodrigo. C. Lamare, and M. Debbah, "[Mutual Coupling-Aware Channel Estimation for Holographic MIMO Systems: A Vector Factorization Design Paradigm](https://ieeexplore.ieee.org/document/11557084)", accepted by **IEEE Trans. Signal Process.**
...
3. **A. Tang**, J.-B. Wang, Y. Pan, M. Xiao, R. C. de Lamare, and J. Wang et al., "[Channel Estimation for XL-MIMO Systems with Decentralized Baseband Processing: Integrating Local Reconstruction with Global Refinement](https://ieeexplore.ieee.org/document/10978081)," in **IEEE Trans. Commun.**, vol. 73, no. 10, pp. 9421-9436, Oct. 2025.
...
4. C. Zeng, H. Zeng, Z. Yang, **A. Tang**, and R. Zhang, "USV Enabled Maritime Rescue System in Dynamic Ocean Environments: From Optimization to Deep Reinforcement Learning," submitted to the IEEE Transactions on Vehicular Technology.
5. H. Zeng, C. Zeng, Z. Yang, **A. Tang**, and R. Zhang, "Physics-Constrained Adaptive USV Trajectory Planning for Flow-Communication-Coupled Maritime Sensing," submitted to the Internet of Things Journal.
6. X. Qian, Y. Pan, **A. Tang**, J.-B. Wang et al., "Near-Field Localization with Distributed Modular Array: Spatial Bandwidth based Design Paradigm", submitted to IEEE Transactions on Vehicular Technology. (Major Revision)
7. Y. Pan, Y. Ji, **A. Tang**, J.-B. Wang, et al., "Sum-Rate Maximization for RSMA Systems with Pattern-Reconfigurable Fluid Antennas", submitted to IEEE Open Journal of the Communications Society. (Major Revision)
8. X. Qian, Y. Pan, **A. Tang**, J.-B. Wang et al., "Unified Tri-Hybrid Beamforming for Multi-User ISAC with Pattern-Reconfigurable Antennas", submitted to IEEE Globecom 2026.
...
# Work Experience
- *2025.12 - Present*, Postdoctoral Researcher in the Department of ECE, The Hong Kong University of Science and Technology.
